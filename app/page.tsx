    ...
    <main className="mx-auto max-w-5xl px-6 py-14">
      ...
      <section className="text-center">
        <div className="mx-auto w-64 overflow-hidden rounded-full border border-black/20 shadow-sm">
          <Image
            src="/17C4EEED-3B01-413C-B86D-004BC65A7095.png"
      ...
      <section className="mt-20">
        ...
        <div className="mt-8 mx-auto max-w-md rounded-2xl border border-black/20 bg-white/40 p-3 shadow-sm">
          <Image
            src="/ACCD8F2A-E9C5-40BD-9955-ED7CA61BD34E.png"
        ...
        <p className="mt-6 text-center mx-auto max-w-2xl opacity-80">
          Four generations of the Winter family: AE Winter (1838–1927),
          Daniel Winter (1866–1948), Albert Winter (1893–1968),
          and Lillian Rose Louise Winter (1918–2005).
        </p>
      </section>
